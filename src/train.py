...
print(f"Număr de imagini în train: {len(train_loader.dataset)}")
print(f"Număr de imagini în val:   {len(val_loader.dataset)}")
print(f"Număr de imagini în test:  {len(test_loader.dataset)}")

# Afișare unei perechi de exemplu (hazy vs clear)
import matplotlib.pyplot as plt
# ia prima pereche din train_loader
